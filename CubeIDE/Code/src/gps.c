...
void configure_gps_receiver(void)	//GPS module-specific, edit according your module and mode of operation you need
{
	...
	//This disables SBAS and GLONASS (GPS + QZSS mode), To avoid cross-correlation issues, it is recommended that GPS and QZSS are always both enabled or both disabled
