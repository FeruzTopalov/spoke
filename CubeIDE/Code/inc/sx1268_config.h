...
#define RF_BITRATEMSB_1280_BPS                      0x61
#define RF_BITRATELSB_1280_BPS                      0xA8
 ...
 * RegFdev (Hz)
 */
#define RF_FDEVMSB_1200_HZ                          0x00
#define RF_FDEVLSB_1200_HZ                          0x14
#define RF_FDEVMSB_1280_HZ                          0x00
#define RF_FDEVLSB_1280_HZ                          0x15
...
#define RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_40MS_1200BPS    0x03  // 5 preamble bytes end at 33 ms, add up ~10%
#define RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_53MS_1200BPS    0x04  // 2 sync word bytes end at 46 ms, add up ~10%
...
#define RFM_CONF_ARRAY {\
		...
		(REG_BITRATEMSB | RFM_WRITE),		(RF_BITRATEMSB_1200_BPS), \
		(REG_BITRATELSB | RFM_WRITE),		(RF_BITRATELSB_1200_BPS), \
		(REG_FDEVMSB | RFM_WRITE),			(RF_FDEVMSB_1200_HZ), \
		(REG_FDEVLSB | RFM_WRITE),			(RF_FDEVLSB_1200_HZ), \
		...
		(REG_RXBW | RFM_WRITE),				(RF_RXBW_MANT_24 | RF_RXBW_EXP_5), 				/*RX bandwidth during receiving*/ \
		(REG_AFCBW | RFM_WRITE),			(RF_AFCBW_MANTAFC_24 | RF_AFCBW_EXPAFC_4), 		/*RX bandwidth during AFC setup*/ \
		...
		(REG_RXTIMEOUT2 | RFM_WRITE),		(RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_40MS_1200BPS), /*RX timeout to switch off if no radio packet incoming*/ \
		(REG_RXTIMEOUT3 | RFM_WRITE),		(RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_53MS_1200BPS), \
		(REG_RXDELAY | RFM_WRITE),			(RF_RXDELAY_INTERPACKETRXDELAY), \
		(REG_OSC | RFM_WRITE),				(RF_OSC_CLKOUT_OFF), \
		(REG_PREAMBLEMSB | RFM_WRITE),		(0), \
		(REG_PREAMBLELSB | RFM_WRITE),		(5), 											/*Number of preamble bytes*/ \
		...
		(REG_SYNCVALUE1 | RFM_WRITE),		(0x4B), 										/*Syncro word*/ \
